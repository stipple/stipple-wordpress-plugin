  ...
  <form method="post" action="options.php">
    ...
    <table class="form-table">
      ...
      <tr valign="top">
        ...
        <td>
          <textarea id="stipple_custom_load_data" rows="8" cols="26" name="stipple_options[custom_stipple_load_data]" <?php disabled(Array('0', '2'), $stipple_load); ?>><?php echo stripslashes( esc_html( $stipple_load_data ) ); ?></textarea>
        </td>
      </tr>
